...
if(isset($_GET['token']))
{
    ...
    $sql = "SELECT `id`, `token_password` FROM `coupart_admin` WHERE `token_password` = :token";
    ...
    /* On récupère l'id de l'administrateur */
                     ...
                     <div class="card">
                         <div class="card-body">
                            <h5 class="card-title">Choisissez votre mot de passe</h5>
                             <form action="passwordAdminTraitement.php?id=<?php echo $user_id ?>" method="post">
                            <div class="mb-3">
